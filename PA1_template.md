...
```r
# Line Graph
ggplot(DayOfWeek, aes(x = interval, y = steps)) + geom_line(col="blue") + facet_grid(DayOf ~ .) + labs(title = "Average Daily Activity Pattern by Weekday vs Weekend", x = "Military Hour", y = "Average Number of Steps")
```
